...
# Supports main.py (unified), main_static.py, and main_dynamic.py
#
...
print_help() {
	...
	echo "EXAMPLES"
	echo "  ./scripts/benchmark.sh bio-wormnet-v3 main.py"
	echo "  ./scripts/benchmark.sh ca-condmat main.py 5"
	echo "  ./scripts/benchmark.sh --all main.py"
	echo "  ./scripts/benchmark.sh --all main.py 3"
	echo "  ./scripts/benchmark.sh bio-wormnet-v3 main_static.py 5"
	echo "  ./scripts/benchmark.sh --all main_dynamic.py 5 0.8"
	echo ""

	echo "PARAMETERS"
	echo "  dataset_name           Name of the dataset from config"
	echo "  main_script            Python script to run (default: main.py)"
